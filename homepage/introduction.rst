...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/rachmaninoff_piano.git
...
* `Sergei Rachmaninoff – Variations on a Theme of Corelli, Op. 42 <https://github.com/DCMLab/rachmaninoff_piano/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the variation theme has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/op42_01a.tsv')
   notes = ms3.load_tsv('notes/op42_01a.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/rachmaninoff_piano/issues>`__ and feel free to fork and submit pull requests.
